...
async def HelpWatermark(bot, cmd):
  ...
  await cmd.reply_text(
    ...
    parse_mode="Markdown",
    reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/AbirHasan2005"), InlineKeyboardButton("Support Group", url="https://t.me/serialcoing")], [InlineKeyboardButton("Bots Channel", url="https://t.me/serialcoin")], [InlineKeyboardButton("Source Code", url="https://github.com/AbirHasan2005/Watermark-Bot")]]),
    disable_web_page_preview=True
  )
  ...
  await cmd.reply_text(
    ...
    reply_markup=InlineKeyboardMarkup(
      [
        ...
        [InlineKeyboardButton("25%", callback_data=f"size_25"), InlineKeyboardButton("30%", callback_data=f"size_30"), InlineKeyboardButton("35%", callback_data=f"size_30"), InlineKeyboardButton("40%", callback_data=f"size_40"), InlineKeyboardButton("45%", callback_data=f"size_45"), InlineKeyboardButton("50%", callback_data=f"size_50")]
      ]
    )
  )
...
async def VidWatermarkAdder(bot, cmd):
  ...
  #output_vid = the_media_file_name  + ".mp4"
  ...
  if int(file_size) > 2097152000:
    ...
    try:
      ...
      print(f"Error: {e}")
      await editable.edit("Sorry, Something went wrong!\n\nCan't Upload to Streamtape. You can report at [Support Group](https://t.me/serialcoing)")
  ...
  try:
    ...
    sent_vid = await bot.send_video(
      ...
      reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/AbirHasan2005")], [InlineKeyboardButton("Bots Channel", url="https://t.me/serialcoin")], [InlineKeyboardButton("Support Group", url="https://t.me/serialcoing")]]),
      progress=progress_for_pyrogram,
      progress_args=(
        "Uploading, Wait ...",
        editable,
...
async def button(bot, cmd: CallbackQuery):
  ...
  if "refreshmeh" in cb_data:
    ...
    await cmd.message.edit(
      text=Config.USAGE_WATERMARK_ADDER,
      parse_mode="Markdown",
      reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/AbirHasan2005"), InlineKeyboardButton("Support Group", url="https://t.me/serialcoing")], [InlineKeyboardButton("Bots Channel", url="https://t.me/serialcoin")]]),
      disable_web_page_preview=True
    )
